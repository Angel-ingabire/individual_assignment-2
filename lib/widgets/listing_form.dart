...
class _ListingFormState extends ConsumerState<ListingForm> {
  ...
  void initState() {
    ...
    latitude = widget.listing?.latitude ?? 0;
    longitude = widget.listing?.longitude ?? 0;
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              TextFormField(controller: _phoneC, decoration: const InputDecoration(labelText: 'Contact')),
              DropdownButtonFormField<String>(value: category, items: const [
                DropdownMenuItem(value: 'Hospital', child: Text('Hospital')),
                DropdownMenuItem(value: 'Police Station', child: Text('Police Station')),
                ...
                DropdownMenuItem(value: 'Tourist Attraction', child: Text('Tourist Attraction')),
              ], onChanged: (v) => setState(() => category = v ?? category)),
              TextFormField(controller: _descC, decoration: const InputDecoration(labelText: 'Description'), maxLines: 3),
              const SizedBox(height: 8),
              Row(children: [
                Expanded(child: Text('Lat: $latitude')),
                Expanded(child: Text('Lng: $longitude')),
              ]),
              const SizedBox(height: 8),
